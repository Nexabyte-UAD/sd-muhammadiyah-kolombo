    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Guru',
                    'url'  => 'admin/guru-staff?tipe=guru',
                    'active' => ['admin/guru-staff?tipe=guru'],
                ],
                [
                    'text' => 'Staf',
                    'url'  => 'admin/guru-staff?tipe=staf',
                    'active' => ['admin/guru-staff?tipe=staf'],
                ],
            ]
        ],
        [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Kata Sambutan',
                    'url'  => 'admin/profil/sambutan',
                ],
                [
                    'text' => 'Visi Misi',
                    'url'  => 'admin/profil/visi_misi',
                ],
                [
                    'text' => 'Tentang Kami',
                    'url'  => 'admin/profil/tentang',
                ],
                [
                    'text' => 'Profil Singkat',
