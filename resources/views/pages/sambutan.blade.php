    ...
    <div class="container py-4">
        <div class="row g-5">
            <div class="col-lg-4 text-center">
                ...
                <p class="text-secondary small">SD Muhammadiyah Kolombo</p>
            </div>
            <div class="col-lg-8">
                ...
                <div class="text-secondary" style="line-height: 1.8; font-size: 1rem;">
                    ...
                    @else
                        ...
                        <p>Selamat datang di website resmi SD Muhammadiyah Kolombo. Puji syukur kita panjatkan ke hadirat Allah SWT atas segala limpahan rahmat dan karunia-Nya.</p>
