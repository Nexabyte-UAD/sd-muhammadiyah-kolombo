            ...
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" id="username" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') }}" required placeholder="Masukkan username unik (hanya huruf, angka, -, _)">
                        @error('username')
                            <span class="error invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
